      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
            <button
              type="button"
              className="inline-flex items-center justify-center rounded-md p-2 text-white-400 hover:bg-red-500 hover:text-white focus:outline-none active:ring-2 active:ring-inset active:ring-white"
      ...
      <div
        className={`${
          value
            ...
            : "transition ease-in duration-75 transform opacity-0 scale-95 hidden  -z-10"
        }`}
        id="mobile-menu"
      >
